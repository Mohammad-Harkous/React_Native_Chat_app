    ...
    <View className="flex-1 items-center justify-start">
            ...
            >
              {avatars.map((item) => (
                <TouchableOpacity onPress={() => handleAvatar(item)}
                  key={item._id}
                  className='w-20 m-3 h-20 p-1 rounded-full border-2 bg-primary relative'
                >
                  <Image
        ...
        <View className="w-full h-full bg-white rounded-tl-[90px] -mt-44 flex items-center justify-start py-6 px-6 space-y-6">
            ...
            <View className='w-full flex items-center justify-center relative -my-4'>
              <TouchableOpacity onPress={() => setIsAvatarOpen(true)} className='w-20 h-20 p-1 rounded-full bg-primary relative'>
                <Image 
                source={{uri: avatar}} 
                className='w-full h-full' 
                resizeMode='contain' 
          ...
          <View className="w-full flex items-center justify-center">
            ...
            {/* login button */}
            <TouchableOpacity className='w-full px-4 py-2 rounded-xl bg-primary my-3 items-center justify-center'>
            ...
            <View className='w-full py-12 flex-row items-center justify-center space-x-2'>
              <Text className='text-base text-primaryText'>Already have an account?</Text>
              <TouchableOpacity onPress={() => navigation.navigate('LoginScreen')}>
                <Text className='text-base font-semibold text-primaryBold'>Login In</Text>
              </TouchableOpacity>
            </View>
